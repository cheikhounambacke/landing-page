      ...
      <div className="max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8">
        <div className="shadow-xl w-full flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300">
          ...
          <div className="text-center font-medium">
            ...
            <p className="py-2 border-b mx-8">1 Ganted User</p>
        ...
        <div className="bg-gray-100 shadow-xl w-full flex flex-col p-4 md:my-0 my-8 rounded-lg hover:scale-105 duration-300">
          <img
          ...
          <button className="text-[#00df9a] w-[200px] rounded-md font-medium my-6 px-6 py-3 mx-auto bg-black">
            Start Trial
          </button>
        </div>
        <div className="shadow-xl w-full flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300">
